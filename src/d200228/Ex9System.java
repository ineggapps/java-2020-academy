...
public class Ex9System {
	public static void main(String[] args) {
		...
		s = System.getProperty("user.dir");// ★ 기억하고 있어야 함.
		System.out.println("현재 작업 경로: " + s);

		System.out.println("===========================");
		// getProperty에 입력하는 Key값과 Key에 대응하는 값(Value)을 모두 출력하는 방법
		// 반복자의 종류: Iterator, ListIterator(앞뒤 양방향 이동이 가능함), Enumeration
