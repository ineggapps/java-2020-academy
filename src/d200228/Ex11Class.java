...
public class Ex11Class {
	public static void main(String[] args) {
		try {
			...
			if (cls.getSuperclass() != null) {// 모든 클래스의 super class는 Object이니까 Object클래스 외에 null값이 나올 일은 없다
			...
			Field[] ff = cls.getDeclaredFields(); //private까지 몽땅 출력
//			Field[] ff = cls.getFields();//public만
			for(Field f: ff) {
				System.out.println(f);
			}
			System.out.println("===========================");
			System.out.println("선언된 메서드들을 알아보자.");
